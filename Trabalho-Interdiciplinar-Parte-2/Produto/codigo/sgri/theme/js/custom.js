...
$(document).ready(function(){  
    ...
    $("#menu li a, #menu li ul li a, .wrapper .controlB ul li a, .logo a").click(function(event){
        ...
        $.post("../"+aUrl, function(eData){
            ...
            $( div ).dialog({
                ...
                function (){
                    ...
                    $(this).html("<center><h5 style='color:#FF0000;'>O endereço requisitado não existe!!!</h5></center");
                },
                buttons: {
                    Fechar: function() {
                        $( this ).dialog( "close" );
